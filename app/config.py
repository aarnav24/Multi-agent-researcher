...
class Settings(BaseSettings):
    ...
    model_reasoning: str = "openai/gpt-oss-120b:free"
    # gemini-3.5-flash for synthesizer only (large input, 1 call/run, 3-key round-robin)
    model_synthesizer: str = "gemini-3.5-flash"
